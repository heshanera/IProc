...
${OBJECTDIR}/BMPProcessor/BMPProcessor.o: BMPProcessor/BMPProcessor.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libpng` `pkg-config --cflags libjpeg` `pkg-config --cflags libtiff-4`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BMPProcessor/BMPProcessor.o BMPProcessor/BMPProcessor.cpp
