...
${OBJECTDIR}/PixelProcessor/PNGPixelProcessor.o: PixelProcessor/PNGPixelProcessor.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libpng` `pkg-config --cflags libjpeg`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PixelProcessor/PNGPixelProcessor.o PixelProcessor/PNGPixelProcessor.cpp
