 ...
 */
int PixelProcessor::resize(int originWidth, int originHeight, int newWidth, int newHeight, int *OriginalArray){
 ...
 */
int PixelProcessor::crop(int row1, int col1, int row2, int col2, int originWidth, int *OriginalArray){
